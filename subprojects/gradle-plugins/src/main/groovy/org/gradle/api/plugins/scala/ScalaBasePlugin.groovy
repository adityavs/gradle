...
public class ScalaBasePlugin implements Plugin<Project> {
    ...
    public void use(Project project) {
        JavaBasePlugin javaBasePlugin = project.plugins.usePlugin(JavaBasePlugin.class);
    ...
    private void configureSourceSetDefaults(Project project, JavaBasePlugin javaBasePlugin) {
        project.convention.getPlugin(JavaPluginConvention.class).sourceSets.allObjects {SourceSet sourceSet ->
            ...
            javaBasePlugin.configureForSourceSet(sourceSet, scalaCompile);
