 ...
 * @author Hans Dockter
 */
public class DefaultOutputTimestampWriter implements OutputTimestampWriter {
    ...
    public void taskSuccessfullyExecuted(Task task) {
        ...
        if (outputTimestampFile.exists() && !task.getDidWork()) {
            return;
        }
        GFileUtils.writeStringToFile(outputTimestampFile, "" + System.currentTimeMillis());
    }

    public void taskFailed(Task task) {
        outputTimestampFilePathCreator.createPath(task).delete();
    }
